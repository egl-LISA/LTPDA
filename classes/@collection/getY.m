% GETY Get the selected data objects property 'y' for the input collection object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: Get the selected data objects property 'y' for the input collection object.
%
% CALL:        y = getY(c1, 'acx')
%              y = getY(c, {'fee_x1','fee_x2'})
%              y = getY(c, fields)
%              y = c.getY('fee_x2')
%
...
%
% OUTPUTS:     y  - matrix with 'y', one column for each input field
%
% <a href="matlab:utils.helper.displayMethodInfo('collection', 'getY')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
