...
classdef timespan < ltpda_uoh
  ...
  properties (Constant = true)
    timeformat = timespan.getTimeformat(); % timeformat of the time span (see preferences)
    timezone   = timespan.getTimezone(); % timezone of the time span (see preferences)
  end
